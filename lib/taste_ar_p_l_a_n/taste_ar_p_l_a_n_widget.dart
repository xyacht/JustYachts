...
class TasteArPLANWidget extends StatefulWidget {
  const TasteArPLANWidget({Key key}) : super(key: key);

  @override
  _TasteArPLANWidgetState createState() => _TasteArPLANWidgetState();
}

class _TasteArPLANWidgetState extends State<TasteArPLANWidget> {
